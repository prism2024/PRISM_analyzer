...
val aprval_summary_dir : string

val aprval_result_dir : string

val aprval_debug_dir : string

val aprval_trace_dir : string

val aprval_dyninfo_br : string

val aprval_dyninfo_invo : string

val aprval_dyninfo_die : string

val aprval_dyninfo_oob : string
...
val aprval_patch_dir : string

val aprval_preproc_org : bool

val aprval_preproc_patch : bool

val aprval_launch_spec_inference : bool

val aprval_launch_validate : bool

val aprval_test_methods : string list
