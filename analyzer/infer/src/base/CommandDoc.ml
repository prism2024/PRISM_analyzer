...
let aprval =
  mk_command_doc ~title:"APRVAL" ~short_description:"APRVAL validate apr-generated patches"
    ~synopsis:"%(b,infer) %(b,aprval) $(b,--) $(i,[NPEX command])" ~description:[`P ""]
    ~see_also:InferCommand.[APRVAL]
